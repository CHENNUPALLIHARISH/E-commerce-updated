...
function validate()
{
  ...
  let un=document.getElementById("n").val;
  let e=document.getElementById("e").val;
  if(un!=" " || e!=" ")
  {
    alert("You have signed for our organisation ");
  }
  else
  {
   alert("Please fill the above details to sign in ");
  }
